...
# 
 ...
 plot_bootstrap_1D(df_b = select_var)
  ...
  test_that("test_bootstrap1",{expect_true(select_var["labo", 1]==mean(c(resBootstrap$bootstrap[[1]][[4]]["labo", 1], resBootstrap$bootstrap[[2]][[4]]["labo", 1]))
) })
 
 test_that("test_bootstrap2",{expect_true(select_var["labo", 2]==resRGCCA$a[[4]]["labo", 1]) })
