...
res=rgcca_permutation(blocks, n_cores = 1,n_run = 21)
...
#res_tau=rgcca_permutation(blocks,par_type="tau",par_value=c(0.7,0.8,0.8))
#res_sparsity=rgcca_permutation(blocks,par_type="sparsity",par_value=c(0.8,0.8,0.8))
