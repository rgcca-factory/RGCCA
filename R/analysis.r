    ...
    if (Sys.info()["sysname"] == "Windows") {
        listFinale <- lapply(1:nbTestFiles, FUN = function(j) {
            ...
            if (noIntersect)
                ...
                selectPatient <- rownames(listRgcca[["Complete"]][["Y"]][[1]])
        ...
        # TODO: mc.cores = parallel::detectCores() - 1
    } else {
        listFinale <- parallel::mclapply(1:nbTestFiles, mc.cores = 7, FUN = function(j) {
