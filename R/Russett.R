#' Russett data
#'
#' @format A data frame with 47 observations on the following 12 variables.
#' \describe{
...
#'
#' @description
#' The Russett data set (Russett, 1964) are studied in Gifi (1990). Three
#' blocks of variables have been defined for 47 countries. The first block
#' X1 = [GINI, FARM, RENT] is related to "Agricultural Inequality":
#' GINI = Inequality of land distribution, FARM = \% farmers that own half
#' of the land (> 50), RENT = \% farmers that rent all their land. The second
#' block X2 = [GNPR, LABO] describes "Industrial Development":
#' GNPR = Gross national product per capita ($1955), LABO = \% of labor
#' force employed in agriculture. The third one X3 = [INST, ECKS, DEAT]
#' measures "Political Instability": INST = Instability of executive (45-61),
...
#' An additional variable DEMO describes the political regime: stable democracy,
#' unstable democracy or dictatorship. Russett collected this data to study
