grgcca_penalized = function(blocks, connection = 1 - diag(length(blocks)),
                            ...
                            na.rm = TRUE, quiet = FALSE, penalty_coef = 0)
{
  ...
  gcca.result <- grgccak_penalized(blocks, connection, tau = tau, scheme = scheme,
