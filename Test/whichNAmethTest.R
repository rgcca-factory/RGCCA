...
resultComparison=whichNAmethod(A=A,listMethods=c("mean","nipals","knn1","knn4","sem1","sem2","sem3","complete"),patternNA=c(0.2,0.2,0.2))
plotAnalysis(resultComparison,output="rmse",fileName=NULL,block="all",barType="sd",namePlot=NULL,width=480,height=480,ylim=NULL)
