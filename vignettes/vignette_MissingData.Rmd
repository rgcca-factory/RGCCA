...
```{r, fig.height = 3, fig.width = 7, fig.align = "center"}
A_missing2=createNA(A,typeNA="byvar",pNA=list(0.1*1:3,rep(0,2),rep(0.1,3)))$dat
...
listResults=naEvolution(A=A,listMethods=c("complete","nipals","mean"),prctNA=c(0.05,0.1,0.15,0.2,0.25,0.3,0.4),typeNA="ponc",ncomp=rep(1,3),sameBlockWeight=FALSE,nDatasets = 10)
```
