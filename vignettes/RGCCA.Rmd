...
While RGCCA encompasses a large number of methods, it is based on a single optimization problem which bears immediate practical implications, facilitating statistical analyses and implementation strategies.
...
general optimization framework presented in Appendix in the next section.
consisting in maximizing a continuously differentiable multi-convex function.
...
centered. A sample-based optimization problem considered within the RGCCA package   
is:
