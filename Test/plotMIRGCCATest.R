...
res=MIRGCCA(A,k=4,ni=5,scale=TRUE,sameBlockWeight=FALSE,tau=rep(0,3),klim=NULL,output="mean",scheme="centroid",tol=1e-16,returnA=TRUE)
res$rgccaList[[2]]$Y[[1]]
res[[1]]$A
plotMIRGCCA(res,multiple="ell",indnames=FALSE)


res=MIRGCCA(option="em",scheme="centroid",tol=1e-16,returnA=TRUE)
