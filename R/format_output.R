...
#      rank <-rgcca_args$rank[,j]
#      col<-""
#      for (kk in 1:length(rank)){
#        for (tt in 1:rank[kk]){
#         
#          if (kk==1 & tt==1){
#            col<-paste0("comp", kk,"_r",tt)
#          }
#          else{
#            col<-cbind(col,paste0("comp", kk,"_r",tt))
#          }
#         
#        } 
#        
...
#      #print(m)
#      #print(dim(func_out$factors[[j]][[m]]))
#      #print(rgcca_args$rank)
#      #print( paste0(
#      #  "comp", rep(seq_len(ncomp), each = r), "_r", seq_len(r)
#      #))
#     #
...
#      #)
#      
#      colnames(func_out$factors[[j]][[m]])<-col
#     # func_out$factors[[j]][[m]] <- func_out$factors[[j]][[m]][, seq_len(
#     #   r * rgcca_args$ncomp[j]
#     # )]
#    }
#  }
#
