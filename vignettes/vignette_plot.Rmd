---
title: "Performs multi-variate analysis (PCA, CCA, PLS, R/SGCCA, etc.) and produces graphical outputs (e.g. variables and individuals plots)"
...
vignette: >
  %\VignetteIndexEntry{Performs multi-variate analysis (PCA, CCA, PLS, R/SGCCA, etc.) and produces graphical outputs (e.g. variables and individuals plots)}
...
selected.var <- get_bootstrap(rgcca_out, boot, n_cores = 2) # Get the bootstrap on the clinic block
