...
stated under several names such as ``learning from multimodal data'',
``data integration'', ``multiview data'', ``multisource data'', ``data
fusion'' or ``multiblock data analysis''. Appropriate statistical
methods and dedicated software able to cope with these multiple highly
multivariate datasets constitute critical issues for effective analysis
leading to valuable knowledge. For the statistical computing environment
R \cite{R2022}, various R packages are available for multiblock data
analysis. Four mainstream references are \(\small{\texttt{mixOmics}}\)
\cite{Rohart2017}, \(\small{\texttt{multiblock}}\) \cite{Liland2022},
\(\small{\texttt{ade4}}\) (\cite{Dray2007}), and
\(\small{\texttt{FactoMineR}}\) \cite{Le2008}. Each package uses its own
way of specifying multiblock models and storing the results. Regularized
Generalized Canonical Correlation Analysis (RGCCA) is a unified
statistical framework that subsumes as special cases an astonishingly
large number of multiblock component methods. In this paper, we present
an R package called RGCCA (Girka et al, 2023) that implements the RGCCA
framework. Its usefulness and versatility are illustrated in this paper.
The package includes several utility functions for data preprocessing
and visualization. In addition, the package includes several built-in
datasets and examples to help users get started quickly.
...
models. It also provides several plots for diagnostics or visualization
of the results from multiblock analysis. Package
\(\small{\texttt{RGCCA}}\) is available from the Comprehensive R Archive
Network (CRAN), at \url{https://CRAN.R-project.org/package=RGCCA} and
can be installed from the R console with the following command:
...
optimization problem under which all the algorithms proposed in the
RGCCA framework were designed. The theoretical foundations of the RGCCA
framework \cite{Tenenhaus2011, Tenenhaus2014, Tenenhaus2015, 
Tenenhaus2017}, are briefly summarized in Section 3, while Sections 4
and 5 illustrates the use of package RGCCA with code examples. The final
...
{\centering \includegraphics{/home/runner/work/RGCCA/RGCCA/docs/articles/RGCCA_files/figure-latex/unnamed-chunk-8-1} 
...
{\centering \includegraphics{/home/runner/work/RGCCA/RGCCA/docs/articles/RGCCA_files/figure-latex/unnamed-chunk-9-1} 
...
{\centering \includegraphics{/home/runner/work/RGCCA/RGCCA/docs/articles/RGCCA_files/figure-latex/unnamed-chunk-10-1} 
...
{\centering \includegraphics{/home/runner/work/RGCCA/RGCCA/docs/articles/RGCCA_files/figure-latex/unnamed-chunk-11-1} 
...
{\centering \includegraphics{/home/runner/work/RGCCA/RGCCA/docs/articles/RGCCA_files/figure-latex/unnamed-chunk-12-1} 
...
gini       0.6602  0.6340 0.0775      0.4338       0.724           8.517 0.0000
farm       0.7445  0.7305 0.0537      0.6428       0.841          13.865 0.0000
rent       0.0994  0.0768 0.2229     -0.3971       0.463           0.446 0.4793
gnpr       0.6891  0.6890 0.0328      0.6130       0.740          20.977 0.0000
labo      -0.7247 -0.7234 0.0302     -0.7901      -0.672         -23.979 0.0000
inst       0.1692  0.1683 0.1119     -0.0733       0.366           1.512 0.0753
ecks       0.4418  0.4342 0.0633      0.2939       0.548           6.981 0.0000
death      0.4784  0.4712 0.0495      0.3660       0.562           9.671 0.0000
demostab  -0.5574 -0.5515 0.0498     -0.6474      -0.453         -11.202 0.0000
dictator   0.4864  0.4822 0.0550      0.3722       0.588           8.845 0.0000
         adjust.pval
gini           0.000
farm           0.000
rent           0.564
...
{\centering \includegraphics{/home/runner/work/RGCCA/RGCCA/docs/articles/RGCCA_files/figure-latex/unnamed-chunk-15-1} 
...
{\centering \includegraphics{/home/runner/work/RGCCA/RGCCA/docs/articles/RGCCA_files/figure-latex/unnamed-chunk-18-1} 
...
{\centering \includegraphics{/home/runner/work/RGCCA/RGCCA/docs/articles/RGCCA_files/figure-latex/unnamed-chunk-23-1} 
